<div class="container-fluid">
    <button type="button" class="btn btn-sm btn-primary mb-3" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-plus fa-sm"></i> Tambah Barang</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <form method="post" action="<?php echo base_url(). 'data_barang/tambah_aksi' ?>" enctype="multipart/form-data">
